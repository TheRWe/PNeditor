...
Logickou úvahou a z vlastností grafů pak můžeme určit někré vzájemné závislosti vlastnosti:
\begin{itemize}
...
V Obrázku \ref{fig:neohraničená síť reversible} vidíme červeně zvírazněnou 
...
stačí pouze spustit skript \textit{src\char`\\Run.bat} a program se zkompiluje do složky 
...
s NodeJS sadou nástrojů. Stačí jen otevřít \textit{PNetEditor.sln} a v horní liště 
visual studia a vybrat možnost "Build" $\to$ "Rebuild solution".


\section{Srovnání s ostatními editory}

Ostatní editory nabízí více funcionality například ve směru analýz, 
...
přiloženého CD, tj.~jeho závazné adresářové struktury, důležitých
souborů apod.

\begin{description}
  \item[\texttt{bin/}] \hfill \\
        Adresář obsahuje soubor pnet\_editor.exe který program spustí. 
  ...
  \item[\texttt{src/}] \hfill \\
        ...
        soubor řešení Visual Studia \textit{PNetEditor.sln},
...
  any network very quickly and conveniently.

  Thanks to this work I have moved my knowledge further. I tried different ways
