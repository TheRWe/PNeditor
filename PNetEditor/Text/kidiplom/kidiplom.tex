...
\begin{wrapfigure}{r}{0.3\textwidth}
  \includegraphics[width=\linewidth]{editor_panel}
  \caption{\\Postranní panel}
  \label{fig:Postranní panel}
\end{wrapfigure}


  Postraní panel obsahuje tlačítka pro práci se záložkami a 
samotné záložky. Pod kategorií \textbf{File} jsou tlačítka: \\ \\
\begin{tabular}{c p{0.55\textwidth}}
  \textbf{New}    & Vytvoří novou prázdnou záložku \\
  \textbf{Load}   & Otevře dialog pro načtení uložené sítě \\
  \textbf{Save}   & Uloží vybranou sít. Pokud byla síť již uložena 
