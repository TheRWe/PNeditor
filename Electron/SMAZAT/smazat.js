document.onload = (function (d3, saveAs, Blob, undefined)
{
    ...
    var GraphEditor = function (svg, nodes, edges)
    {
        var thisGraph = this;
        thisGraph.idct = 0;
    ...
    GraphEditor.prototype.setIdCt = function (idct)
    {
        this.idct = idct;
    };
    ...
    GraphEditor.prototype.deleteGraph = function (skipPrompt)
    {
        var thisGraph = this,
            doDelete = true;
        if (!skipPrompt) {
    ...
    GraphEditor.prototype.insertTitleLinebreaks = function (gEl, title)
    {
    ...
    // mousedown on node
    GraphEditor.prototype.circleMouseDown = function (d3node, d)
    {
        var thisGraph = this,
            state = thisGraph.state;
        d3.event.stopPropagation();
    ...
    GraphEditor.prototype.changeTextOfNode = function (d3node, d)
    {
        var thisGraph = this,
    ...
    // mouseup on nodes
    GraphEditor.prototype.circleMouseUp = function (d3node, d)
    {
        var thisGraph = this,
            state = thisGraph.state,
            consts = thisGraph.consts;
    ...
    var svg = d3.select("body").append("svg")
        .attr("width", width)
        .attr("height", height);
    var graph = new GraphEditor(svg, nodes, edges);
    graph.setIdCt(2);
    graph.updateGraph();
