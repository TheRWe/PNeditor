import { Place, Arc, Transition, PNetModel } from "./PNetModel";
...
export class PNetDraw extends DrawBase<PNetModel>{
    public Callbacks: {
        [key: string]: Callbacks<any>;
        container: Callbacks<{}>;
    };
    protected Selectors: { [key: string]: d3.Selection<d3.BaseType, any, d3.BaseType, any>; };
